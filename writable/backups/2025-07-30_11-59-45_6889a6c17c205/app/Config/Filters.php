...
class Filters extends BaseFilters
{
        ...
        'before' => [
            ...
            'isLoggedIn' => [
                'except' => [
                    ...
                    'login',
                    'auth/*',
                    'api/*', // Exclude all API endpoints from login requirement
                ]
            ],
            // 'invalidchars',
            // 'sessiontimeout' => ['except' => ['login', 'auth/*']], // Menambahkan pengecualian untuk login page dan controller lainnya
        ],
        'after' => [
            // 'honeypot',
            // 'secureheaders',
    ...
    public array $filters = [
        // Filter isLoggedIn sudah diterapkan secara global
        // Hapus filter individual untuk menghindari duplikasi
    ];
}
